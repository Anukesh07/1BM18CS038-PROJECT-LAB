...
$vv= $_SESSION['submit'] ;
$vv=$vv+0 ;
$sql = 'select * from Student where Email='.$vv ;                      //Teacher for teachers
...
<div class="card" id="prof" onclick="off()">                                     <!--from here-->
	<span>Username: </span><?php echo htmlspecialchars($result['Username']);?><br>
	<span>Unique ID: </span><?php echo htmlspecialchars($result['Unique ID']);?><br>
	<div class="q0"> <span>Questions</span><br>
		<?php
		$t0="Questions.php";
		$ln1= echo htmlspecialchars($result['Questions']);
		link($t0, $ln1);
		?>
	</div>
	<div class="q00"> <span>Answers</span><br>
		<?php
		$t00="Answers.php";
		$ln2= echo htmlspecialchars($result['Answers']);
		link($t00, $ln2);
		?>
	</div>
	<br>
